...
struct	pentry	{
	...
	int	pwaitret;
        ...
        /* The list of system calls and their designated positions in the below arrays */
        /*
         * freemem 0, chprio 1, getpid 2, getprio 3, gettime 4, kill 5, receive 6,
         * recvclr 7, recvtim 8, resume 9, scount 10, sdelete 11, send 12, setdev 13,
         * setnok 14, screate 15, signal 16, signaln 17, sleep 18, sleep10 19, sleep100 20,
         * sleep1000 21, sreset 22, stacktrace 23, suspend 24, unsleep 25, wait 26
         */
        int     call_count_array[27];   /* This array will hold the number of times the method is called */
        long    start_time_array[27];   /* This array will hold the start times of method calls */
        long    end_time_array[27];     /* THis array will hold the end times of the method calls */
};
...
extern	int	currpid;		/* currently executing process	*/
	int     start_stop_flag;         /* Used to know if there is a need to calculate the times */
