...
struct	pentry	{
	...
	int	pwaitret;
	int	goodness;		/* Added a field to calculate goodness for Linux Like scheduler 	*/
	int	counter;		/* Added counter to keep a track of it to update goodness		*/
	int	time_quant		/* Time quantum will store the total time allowed for this process	*/
};
